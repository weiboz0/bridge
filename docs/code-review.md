...
Code review happens during Step 5 in `docs/development-workflow.md`. Bridge runs a **3-way review** (self + Codex + GLM) on every PR — see `docs/reviewers.md` for the dispatch table and gate rules.
